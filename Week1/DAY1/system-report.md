...
![release](/Week1/working_folder/Day1/Task1/Screenshots_day1_task1/cat_etc_os_release.png)
b. hostnamectl
...
![hostname](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/hostnamectl.png)
c. lsb*release -a
...
![lsb](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/lsb_release-a.png)
d. cat /etc/*-release
...
![psp](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/ps-p$$.png)
b. echo $0
    DESCRIPTION: The name the shell was invoked with
    RELIABILITY FOR CURRENT SHELL: Medium
    ![echozero](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/ech-$0.png)
    c. ls -l /proc/$$/exe
    DESCRIPTION: The actual shell executable path
    RELIABILITY FOR CURRENT SHELL: High
    ![proc](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/ls-l-proc-$$-exe.png)
    d. echo $$SHELL
DESCRIPTION: Your default configured logon shell.
RELIABILITY FOR CURRENT SHELL: Low
![shell](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/echo$$shell.png) 3. NODE BINARY PATH
...
Commands before installing nodejs npm-----> ![not](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/npm-before-installation.png)
Command to install nodejs npm-------------> ![install](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/install-nodejs-npm.png)
a. which node
Displays full path to the node executable that your shell will use when you type node.
![node](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/which-node.png)
b. which nodejs
...
![nodejs](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/which-node-js.png)
c. whereis node
...
![whereis](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/where-is-node.png)
d. type node
command tells you whether node is a built-in command, a function, an alias, or a binary file and provides it location.
![type](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/type-node.png)
e. npm bin -g
...
![bin](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/npm-bin-g.png) 4. NPM GLOBAL INSTALLATION PATH
a. npm root -g
This command prints the absolute path to the directory where global packages are installed
![root](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/nom-root-g.png)
...
![config](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/npm-config-get-prefix.png) 5. ALL PATH ENTRIES THAT INCLUDE "node" OR "npm"
a. echo $PATH | tr ':' '\n' | grep -i 'node/|npm'
List PATH entries and show only directories related to Node or npm.
![echo](/Week1/working_folder/Day1/Task1/Screenshots-day1-task1/echo-path-tr-grep.png)

...
# # ----------------------
# # MEMORY COORDINATOR — wires short-term, long-term, and vector memory together.
# # """
...
# # # ---------------------------------------------------------------------------
# # # Prompts — kept minimal to avoid model confusion
# # # ---------------------------------------------------------------------------
...
# #         """
# #         Direct client.create() call with SystemMessage + UserMessage.
# #         SystemMessage = instructions + memory context.
# #         UserMessage = conversation history + latest user input.
# #         """
# #         # Build system content from the first system message
# #         system_content = next(
# #             (m["content"] for m in messages if m["role"] == "system"),
# #             SYSTEM_PROMPT
# #         )

# #         # Build conversation history + last user message as one UserMessage
# #         history_lines = []
# #         for m in messages:
# #             if m["role"] == "user":
...
# #         for artifact in ["User:", "Assistant:", "Previous conversation:"]:
...
# #     # ------------------------------------------------------------------
# #     # Fact extraction — uses a direct LLM call with minimal prompt
# #     # ------------------------------------------------------------------
...
# #                         "Write each fact in third person WITHOUT apostrophes. "
# #                         "Use formats like: 'User name is Shreya', 'User works at HestaBit', 'User is a software engineer trainee'. "
# #                         "Copy names and places EXACTLY as written — never change spelling. "
# #                         "Only include facts explicitly stated. Never infer or invent. "

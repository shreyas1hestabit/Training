...
# -----------------------------
# NEXUS AI Master Orchestrator — Groq edition.

# Groq runs llama-3.1-8b-instant at ~500 tokens/sec so we enable the
# full pipeline including Critic loop and Validation — much faster than Ollama.
# """
...
# # ---------------------------------------------------------------------------
# # NEXUS Orchestrator — Groq edition
# # ---------------------------------------------------------------------------
...
#         report = await self._fast_pipeline(task) if mode == "fast" else await self._full_pipeline(task)
...
#     # ------------------------------------------------------------------
#     # FAST pipeline — 2-3 agents, no planner
#     # ------------------------------------------------------------------
...
#     # ------------------------------------------------------------------
#     # FULL pipeline — Planner + multi-agent + Critic loop
#     # ------------------------------------------------------------------

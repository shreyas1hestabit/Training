...
![i](/screenshots/i1.png)

`pwd` print working directory
![g](/screenshots/i2.png)

`ls /` structure of root directory.
![if](/screenshots/i3.png)

`ps` list running processes
![il](/screenshots/i4.png)

`top` live process monitor
![ik](/screenshots/i5.png)

`df -h` disk usage space
![iw](/screenshots/i6.png)

`du -sh /app` total size of directory
![ia](/screenshots/i7.png)

`whoami` current user
![isd](/screenshots/i8.png)

`id` user identity details
![im](/screenshots/i9.png)
